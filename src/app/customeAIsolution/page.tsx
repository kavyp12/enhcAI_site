...
<div className="font-product-sans bg-[var(--bg-main)] text-[var(--text-main)] flex w-full items-center justify-center px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24 pt-20 sm:pt-24 lg:pt-24">          <div className="flex w-full max-w-7xl flex-col gap-8 sm:gap-10 lg:flex-row lg:gap-20">
        ...
        <button className="bg-[var(--brand-primary)] text-white font-semibold py-3 px-6 sm:py-4 sm:px-8 rounded-full flex items-center gap-3 whitespace-nowrap transition-transform transform hover:scale-105 hover:bg-[var(--brand-primary-hover)]">
            Get in touch today
            <ArrowIcon />
        </button>
    </div>
