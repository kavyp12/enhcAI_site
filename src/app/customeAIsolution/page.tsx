...
const LogoCard = ({ children }: { children: ReactNode }) => (
  <div className="bg-[#161616] rounded-2xl h-36 flex items-center justify-center p-6 hover:grayscale-0 transition-all duration-300 ease-in-out cursor-pointer min-w-[280px] sm:min-w-[300px] flex-shrink-0">
    {children}
  </div>
);
    ...
    <>
      ...
      <div>
        ...
        <div className="bg-black min-h-screen">
          {/* Hero Section */}
          <div className="font-product-sans bg-black text-white flex w-full items-center justify-center px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24">
            <div className="flex w-full max-w-7xl flex-col gap-8 sm:gap-10 lg:flex-row lg:gap-20">
              <div className="flex-1 text-center lg:text-left">
                <p className="mb-4 text-base sm:text-lg">• Custom AI Solutions</p>
              ...
              <div className="flex-1 text-base sm:text-lg lg:text-xl leading-relaxed text-gray-300 text-center lg:text-left">
                <p className="mb-6">
          ...
          {/* Image Section */}
          <div className="w-full bg-black px-4 sm:px-6 lg:px-8 pb-12 sm:pb-16">
          ...
          <div className="w-full bg-black text-white px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
            <div className="flex w-full max-w-7xl mx-auto flex-col lg:flex-row gap-12 lg:gap-20 items-center">
              <div className="flex-1 space-y-6 text-center lg:text-left">
                <p className="text-base sm:text-md">• We approach every project with a clear vision.</p>
          ...
          <div className="w-full bg-black text-white px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
            <div className="w-full max-w-7xl mx-auto flex flex-col items-center">
              <div className="flex flex-col w-full text-center">
                <h1 className="text-3xl sm:text-4xl lg:text-5xl font-semibold text-white mt-2 max-w-5xl leading-tight">
          ...
          {/* Services Section */}
          <div className="bg-[#000000] text-white font-sans px-4 sm:px-6 lg:px-8 py-12 sm:py-16 rounded-xl">
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-12 lg:mb-24 max-w-7xl mx-auto">
              ...
              <div className="mt-8 lg:mt-0 w-full flex justify-center lg:justify-start">
                <button className="bg-[#D4FF40] text-black font-semibold py-3 px-6 sm:py-4 sm:px-8 rounded-full flex items-center gap-3 whitespace-nowrap transition-transform transform hover:scale-105">
                  Get in touch today
                  <ArrowIcon />
                </button>
              </div>
          ...
          <section className="testimonial-section bg-black text-white w-full py-12 sm:py-20 lg:py-28 font-product-sans">
          ...
          {/* Our Work Section */}
          <section className="work-section bg-black text-white w-full py-12 sm:py-20 lg:py-28 font-product-sans px-4 sm:px-6 lg:px-8">
            <div className="max-w-[90rem] mx-auto">
              <div className="flex flex-col sm:flex-row justify-between items-start mb-12 sm:mb-16">
                <div className="text-center sm:text-left">
                  <p className="text-base sm:text-lg mb-4">• Our Work</p>
