...
// --- SVG Icon Components ---
// These icons are being repurposed for the new service offerings.
...
const blogPosts = [
    {
      ...
      readTime: '6 min read',
      title: 'The Strategic Imperative of AI in Modern Business',
      description: 'How AIInnovate helps businesses build a strategic framework for long-term AI success...',
    },
    {
      id: 2,
      image: 'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=2070&q=80',
      readTime: '10 min read',
      title: 'Building a Framework for Responsible AI Strategy',
      description: 'Co-Founder Dr. Jane Smith on our commitment to ethical AI consulting and why governance matters...',
    },
    {
      id: 3,
      image: 'https://images.unsplash.com/photo-1551288049-bcc0d0a70e66?auto=format&fit=crop&w=2070&q=80',
      readTime: '4 min read',
      title: 'Why Partner with AIInnovate for AI Consulting?',
      description: 'Hi, I’m Dr. Jane, Co-Founder of AIInnovate, an AI consultancy based in San Francisco dedicated to crafting innovative AI strategies...',
    },
    {
      id: 4,
      image: 'https://images.unsplash.com/photo-1517694712202-14dd9538aa97?auto=format&fit=crop&w=2070&q=80',
      readTime: '8 min read',
      title: 'Navigating the Future: An AI Strategy-First Approach',
      description: 'Exploring how AIInnovate’s strategic consulting is transforming industries by prioritizing planning and roadmapping...',
    },
];
          ...
          <div className="bg-black min-h-screen">
              <div className="font-product-sans bg-black text-white flex min-h-screen w-full items-center justify-center p-8 sm:p-16 lg:p-24">
                  <div className="flex w-full max-w-7xl flex-col gap-10 lg:flex-row lg:gap-20">
                      ...
                      <div className="flex-1 text-center lg:text-left">
                          <p className="mb-4 text-lg">• AI Strategy & Consulting</p>
                      ...
                      <div className="flex-1 pt-2 text-base sm:text-lg leading-relaxed text-gray-300 lg:text-xl text-center lg:text-left">
                          ...
                          <p>
                              AI Strategy, Opportunity Analysis, Data Governance, and Technology Roadmapping — we cover all areas of strategic planning. We help startups with novel ideas define a clear path to an AI-powered product. We guide established enterprises in revamping existing systems with intelligent automation or reaching the next level with predictive analytics. Our talented <span className="text-white underline decoration-gray-500 decoration-1 underline-offset-4">AI strategy team</span> will collaborate with you to build a roadmap that reflects your brand, solves critical business problems, and delivers measurable results.
                          </p>
                      </div>
                  </div>
              </div>
              ...
              <div className="w-full bg-black px-4 sm:px-8 lg:px-24 pb-16">
                  <div className="relative w-full max-w-7xl mx-auto h-[40vh] sm:h-[50vh] lg:h-[60vh] overflow-hidden rounded-2xl sm:rounded-3xl">
                      ...
                      <div className="absolute top-4 left-4 sm:top-6 sm:left-6 bg-black bg-opacity-80 px-4 py-2 sm:px-5 sm:py-3 rounded-full backdrop-blur-sm">
                          <span className="text-white text-xs sm:text-sm font-medium">Learn about our approach</span>
              ...
              <div className="w-full bg-black text-white px-8 sm:px-16 lg:px-24 py-16">
                  <div className="flex w-full max-w-7xl mx-auto flex-col gap-10 lg:flex-row lg:gap-20 items-center">
                      {/* Left Column */}
                      <div className="flex-1 text-center lg:text-left">
                          <p className="mb-6 text-lg">• AI Consulting</p>
                      ...
                      <div className="flex-1 w-full text-center lg:text-left lg:pt-16 lg:-translate-y-15 lg:translate-x-80">
                          <h3 className="text-gray-400 text-sm mb-4">Our Consulting Services</h3>
                      ...
                      <div className="mt-16 overflow-hidden w-full">
                          ...
                          <div className="mb-6">
                              <div className="flex animate-scroll-left gap-6">
                                  ...
                                  <LogoCard><p className="text-4xl font-bold text-white">Figma</p></LogoCard>
                                  <LogoCard><p className="text-4xl font-bold text-white">Notion</p></LogoCard>
                                  <LogoCard><p className="text-4xl font-bold text-white">Midjourney</p></LogoCard>
                                  <LogoCard><p className="text-4xl font-bold text-white">Anthropic</p></LogoCard>
                          ...
                          <div>
                              <div className="flex animate-scroll-right gap-6">
                                  ...
                                  <LogoCard><p className="text-4xl font-bold text-white">React</p></LogoCard>
                                  <LogoCard><p className="text-4xl font-bold text-white">Tailwind</p></LogoCard>
                                  <LogoCard><p className="text-4xl font-bold text-white">Stability AI</p></LogoCard>
                                  <LogoCard><p className="text-4xl font-bold text-white">Next.js</p></LogoCard>
                                      ...
                                      <div className="relative h-[400px] bg-gradient-to-br from-blue-900 to-gray-900 flex items-center justify-center">
                                          ...
                                          <div className="relative z-10 text-center p-8">
                                              <div className="text-white text-5xl font-bold flex items-center justify-center flex-col gap-4">
                                                  ...
                                                  <span className="text-transparent" style={{ WebkitTextStroke: '2px #c6ff00', WebkitTextFillColor: 'transparent' }}>Strategy</span>
                                              </div>
                                          </div>
                                      </div>
                                  </div>
