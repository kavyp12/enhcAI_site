...
@media (max-width: 640px) {
    ...
    .animate-scroll-right { animation: scroll-right 8s linear infinite; } /* Faster on mobile */
      ...
      <div className="overflow-hidden bg-black py-8">
        <div className="left-text w-full text-white text-6xl md:text-8xl xl:text-9xl font-bold whitespace-nowrap leading-none">
          Let's work together. Let's work together. Let's work together.
        </div>
        <div className="right-text w-full text-white text-6xl md:text-8xl xl:text-9xl font-bold whitespace-nowrap leading-none">
          Let's work together. Let's work together. Let's work together.
        </div>
      </div>
    </>
